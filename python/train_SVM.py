...
def main(multi_mode='ovo', winL=90, winR=90, do_preprocess=True, use_weight_class=True, 
    ...
    db_path = '/content/drive/MyDrive/ECG_project/mitdb/m_learning/'
    ...
    if do_cross_val:
        ...
        perf_measures_path = create_svm_model_name('/content/drive/MyDrive/ECG_project/results/' + multi_mode, winL, winR, do_preprocess, 
